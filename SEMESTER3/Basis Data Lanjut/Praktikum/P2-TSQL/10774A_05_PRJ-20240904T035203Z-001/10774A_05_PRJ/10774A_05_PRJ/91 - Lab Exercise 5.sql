...
-- Task 2
-- 
-- Write a SELECT statement to retrieve the empid, firstname, and lastname columns from the HR.Employees table and the calendardate column from the 
-- HR.Calendar table.
--
-- Execute the written statement and compare the results that you got with the recommended result shown in the file 92 - Lab Exercise 5 - Task 2 
-- Result.txt. 
--
