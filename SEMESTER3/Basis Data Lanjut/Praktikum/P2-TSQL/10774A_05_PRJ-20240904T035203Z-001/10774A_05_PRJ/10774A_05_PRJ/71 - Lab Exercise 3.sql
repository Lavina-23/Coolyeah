...
SELECT
	e.empid, e.lastname, e.firstname, e.title, e.mgrid, mgr.mgrid AS mgrid , mgr.lastname AS mgrlastname, mgr.firstname AS mgrfirstname
FROM HR.Employees AS e, HR.Employees AS mgr
WHERE e.empid = mgr.mgrid;
